      ...
      <Container>
        <div className="w-full h-full text-primary-100">
          ...
          <div className="flex lg:justify-center">
            <h1 className=" w-[55%] lg:w-[440px] leading-tight font-semibold lg:font-bold text-[20px] px-0 lg:px-5 lg:text-[52px] lg:text-center">
              Your Well-Being is Our Priority
            </h1>
          </div>{" "}
          <div className="flex lg:justify-center py-5">
            <p className=" text-[12px] lg:text-[22px] w-[563px] lg:text-center  lg:px-3">
