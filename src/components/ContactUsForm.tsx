...
const ContactUsForm = () => {
  return (
    <section className="w-full pt-10 my-5 lg:my-10">
      <Container>
        <form className=" relative hidden lg:block w-full min-h-[909px] rounded-[50px] text-primary-100 bg-white p-16 border border-[#B1B1B1] ">
        ...
        {/* mobile */}
        <form className="lg:hidden h-[544px] w-full text-primary-100 p-5 rounded-4xl border border-[#B1B1B1]">
